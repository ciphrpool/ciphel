...
impl<E: crate::vm::external::Engine> crate::vm::AsmName<E> for MathAsm {
    fn name(&self, stdio: &mut StdIO, program: &crate::vm::program::Program<E>, engine: &mut E, pid : E::PID) {
        match self {
            MathAsm::Ceil => stdio.push_asm_lib(engine, pid, "ceil"),
            MathAsm::Floor => stdio.push_asm_lib(engine, pid, "floor"),
            MathAsm::Abs => stdio.push_asm_lib(engine, pid, "abs"),
            MathAsm::Exp => stdio.push_asm_lib(engine, pid, "exp"),
            MathAsm::Ln => stdio.push_asm_lib(engine, pid, "ln"),
            MathAsm::Log => stdio.push_asm_lib(engine, pid, "log"),
            MathAsm::Log10 => stdio.push_asm_lib(engine, pid, "log10"),
            MathAsm::Pow => stdio.push_asm_lib(engine, pid, "pow"),
            MathAsm::Sqrt => stdio.push_asm_lib(engine, pid, "sqrt"),
            MathAsm::Acos => stdio.push_asm_lib(engine, pid, "acos"),
            MathAsm::Asin => stdio.push_asm_lib(engine, pid, "asin"),
            MathAsm::Atan => stdio.push_asm_lib(engine, pid, "atan"),
            MathAsm::Atan2 => stdio.push_asm_lib(engine, pid, "atan2"),
            MathAsm::Cos => stdio.push_asm_lib(engine, pid, "cos"),
            MathAsm::Sin => stdio.push_asm_lib(engine, pid, "sin"),
            MathAsm::Tan => stdio.push_asm_lib(engine, pid, "tan"),
            MathAsm::Hypot => stdio.push_asm_lib(engine, pid, "hypot"),
            MathAsm::Deg => stdio.push_asm_lib(engine, pid, "deg"),
            MathAsm::Rad => stdio.push_asm_lib(engine, pid, "rad"),
            MathAsm::CosH => stdio.push_asm_lib(engine, pid, "cosh"),
            MathAsm::SinH => stdio.push_asm_lib(engine, pid, "sinh"),
            MathAsm::TanH => stdio.push_asm_lib(engine, pid, "tanh"),
            MathAsm::ACosH => stdio.push_asm_lib(engine, pid, "acosh"),
            MathAsm::ASinH => stdio.push_asm_lib(engine, pid, "asinh"),
            MathAsm::ATanH => stdio.push_asm_lib(engine, pid, "atanh"),
            MathAsm::Pi => stdio.push_asm_lib(engine, pid, "pi"),
            MathAsm::E => stdio.push_asm_lib(engine, pid, "e"),
            MathAsm::Inf => stdio.push_asm_lib(engine, pid, "inf"),
            MathAsm::NInf => stdio.push_asm_lib(engine, pid, "ninf"),
            MathAsm::IsNaN => stdio.push_asm_lib(engine, pid, "isnan"),
            MathAsm::IsInf => stdio.push_asm_lib(engine, pid, "isinf"),
        }
    }
}
