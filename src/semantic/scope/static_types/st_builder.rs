...
//         scope_id: Option<u128>,
//     ) -> Result<Self, SemanticError> {
//         let inner = type_sig.item_type.type_of(&scope_manager, scope_id)?;
...
//         scope_id: Option<u128>,
//     ) -> Result<Self, SemanticError> {
//         let subtype = type_sig.0.type_of(&scope_manager, scope_id)?;
...
//         scope_id: Option<u128>,
//     ) -> Result<Self, SemanticError> {
//         let subtype = type_sig.type_of(&scope_manager, scope_id)?;
//         Ok(Self::Vec(VecType(Box::new(subtype))))
//     }
...
//         scope_id: Option<u128>,
//     ) -> Result<Self, SemanticError> {
//         let key_type = type_sig.keys_type.type_of(&scope_manager, scope_id)?;
//         let subtype = type_sig.values_type.type_of(&scope_manager, scope_id)?;
//         Ok(Self::Map(MapType {
