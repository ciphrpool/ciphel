...
//                 let _ = instructions.push(Casm::Core(CoreCasm::Std(StdCasm::IO(IOCasm::Print(
//                     PrintCasm::PrintAddr,
//                 )))));
//                 Ok(())
//             }
...
//             StaticType::Unit => {
//                 let _ = instructions.push(Casm::Core(CoreCasm::Std(StdCasm::IO(IOCasm::Print(
//                     PrintCasm::PrintID("unit".to_string().into()),
//                 )))));
//                 Ok(())
//             }
//             StaticType::Any => {
//                 let _ = instructions.push(Casm::Core(CoreCasm::Std(StdCasm::IO(IOCasm::Print(
//                     PrintCasm::PrintID("any".to_string().into()),
//                 )))));
//                 Ok(())
//             }
//             StaticType::Error => {
...
//     fn build_printer(&self, instructions: &mut CasmProgram) -> Result<(), CodeGenerationError> {
//         match self {
//             NumberType::U8 => instructions.push(Casm::Core(CoreCasm::Std(StdCasm::IO(
//                 IOCasm::Print(PrintCasm::PrintU8),
//             )))),
//             NumberType::U16 => instructions.push(Casm::Core(CoreCasm::Std(StdCasm::IO(
//                 IOCasm::Print(PrintCasm::PrintU16),
//             )))),
//             NumberType::U32 => instructions.push(Casm::Core(CoreCasm::Std(StdCasm::IO(
//                 IOCasm::Print(PrintCasm::PrintU32),
//             )))),
//             NumberType::U64 => instructions.push(Casm::Core(CoreCasm::Std(StdCasm::IO(
//                 IOCasm::Print(PrintCasm::PrintU64),
//             )))),
//             NumberType::U128 => instructions.push(Casm::Core(CoreCasm::Std(StdCasm::IO(
//                 IOCasm::Print(PrintCasm::PrintU128),
//             )))),
//             NumberType::I8 => instructions.push(Casm::Core(CoreCasm::Std(StdCasm::IO(
//                 IOCasm::Print(PrintCasm::PrintI8),
//             )))),
//             NumberType::I16 => instructions.push(Casm::Core(CoreCasm::Std(StdCasm::IO(
//                 IOCasm::Print(PrintCasm::PrintI16),
//             )))),
//             NumberType::I32 => instructions.push(Casm::Core(CoreCasm::Std(StdCasm::IO(
//                 IOCasm::Print(PrintCasm::PrintI32),
//             )))),
//             NumberType::I64 => instructions.push(Casm::Core(CoreCasm::Std(StdCasm::IO(
//                 IOCasm::Print(PrintCasm::PrintI64),
//             )))),
//             NumberType::I128 => instructions.push(Casm::Core(CoreCasm::Std(StdCasm::IO(
//                 IOCasm::Print(PrintCasm::PrintI128),
//             )))),
//             NumberType::F64 => instructions.push(Casm::Core(CoreCasm::Std(StdCasm::IO(
...
//             }
//             PrimitiveType::Char => instructions.push(Casm::Core(CoreCasm::Std(StdCasm::IO(
//                 IOCasm::Print(PrintCasm::PrintChar),
//             )))),
//             PrimitiveType::Bool => instructions.push(Casm::Core(CoreCasm::Std(StdCasm::IO(
